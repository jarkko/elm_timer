...
Elm.Uuid.make = function (_elm) {
   ...
   var fromString = function (text) {    return $Uuid$Barebones.isValidUuid(text) ? $Maybe.Just(Uuid(text)) : $Maybe.Nothing;};
...
Elm.ElmTimer.make = function (_elm) {
   ...
   var init = {runners: _U.list([{first_name: "Jarkko",last_name: "Laine",id: "abcde"},{first_name: "Tarmo",last_name: "Tänav",id: "abcdef"}])
